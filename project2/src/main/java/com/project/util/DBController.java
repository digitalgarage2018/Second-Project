...
public class DBController {
    ...
    protected static final String DB_URL = "jdbc:mysql://localhost:3306/WebImmobiliare";
    protected static final String USER = "nde";
    protected static final String PASS = "$Digital0";
