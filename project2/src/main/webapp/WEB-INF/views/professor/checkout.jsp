          ...
          <tbody>
            <tr>
			   ...
			   <td data-th="Video">
					<center>
					<div>
						<a href="#" data-toggle="modal" data-target="#login-modal2"class="btn btn-general btn-green" >Gestione video</a>
					</div> 
					</center>
				</td>
				...
				<td data-th="Test">
					<center>
					<div>
						<a href="cart.html" class="btn btn-general btn-green" >Gestione Test</a>
					</div> 
					</center>
				</td>
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div id="div-forms">
                          ...
                          <h3 class="text-center">Gestione video</h3>
                          <div class="modal-body"> 
                            <form action="upload.asp" method="post"> <input type="file" class="form-control text-center" value="" name="file1">
							</form>
							<form action="upload.asp" method="post"> <input type="file" class="form-control text-center" value="" name="file1">
                          ...
                          <div class="modal-footer">
                              <div>
                                  <button type="submit" class="btn btn-general btn-white">Salva</button>
                              </div>
