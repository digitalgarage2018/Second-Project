...
<script type='text/javascript'>
    ...
    for (let exam of exams) {
        ...
        testRow.innerHTML     = "<center><div><br><a href='professor/creaTest.jsp' class='btn btn-general btn-green' >Gestione Test</a></div> </center>";
        ...
        save_btn.addEventListener( "click", function() {
            //TODO devo ottenere tutti i valori e spedirli al controller.

            let exam = examsList[index_btn - 1];

            console.log( "INDEX: " + index_btn );
            // TODO ottenere tutti i video
            let videos = [];
            ...
            // TODO ottenere tutte le dispense
            let notes = [];
            ...
            $.ajax({
                url:"http://localhost:8080/Project2/insertMaterialController",
                data:{
    ...
    function addVideo( index )
    {
        ...
        if (exam["counterVideo"] == LIMIT_VIDEO) {
            ...
            // TODO mi devo creare l'element. no problem
    ...
    function addDispensa( index )
    {
        ...
        if (exam["counterDispensa"] == LIMIT_DISPENSA) {
            ...
            // TODO pure qui creare l'elemento
